...
projects = [
 ...
 {- , Project { projectName      = "library"
            ...
            , projectStartHook = Just $ do shellPrompt  switchXPConfig--runOrRaisePrompt runOrRaiseXPConfig -- "konsole"
...
ultimateXPConfig = greenXPConfig {
 ...
 --                              ,  position =  CenteredAt {xpCenterY = 0.24 , xpWidth = 0.88}
  				, position = Top                             
                               ,  font = "xft:SourceCodePro:size=17"
                       }
...
myKeys' = [  ("konsole" ,  namedScratchpadAction myScratchPads "konsole")-- ("trivial" , spawn "")
      ...
      , ("qdeleteAll" , killAll)
      , ("oCust", xmonadPromptC custList myXPConfig)
      , ("jList", xmonadPromptC webList myXPConfig)
...
--      , ("ug2" ,  namedScratchpadAction myScratchPads "syllabus")
      ...
      , ("vindows", windowPrompt ultima2XPConfig Goto allWindows)
 ...
 --     ,  ("exrestart" ,spawn "xmonad --recompile ; xmonad --restart")
  --    ,  ("xmonadPrompt", xmonadPromptC xmonadEdit ultima2XPConfig)
      ...
      , ("aSearch" , xmonadPromptC searchPrompts ultimateXPConfig)
...
custList = [("php",spawn "konsole -e php -S localhost:4000")
	   ,("htop",spawn "konsole -e htop")]

searchPrompts = [("books"    ,  S.promptSearch  myXPConfig books)
      		, ("playStore" , S.promptSearch  myXPConfig nixos )
      		, ("server" , S.promptSearch  myXPConfig php )
